...
namespace ChristinaCreatesGames.Animations
{
    public class SquashAndStretch : MonoBehaviour
    {
        ...
        [SerializeField, Tooltip("Defaults to current G.O if not set.")] private Transform transformToAffect;
        ...
        //Add a button to activate the test below:
        //leaving this error here to mark that this needs to be done. Clear when finished.
